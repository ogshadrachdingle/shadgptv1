...
export default function ShadGPT() {
  const [messages, setMessages] = useState([
    {
      role: "system",
      content: "You are ShadGPT, a witty chatbot that replies in a thick Yorkshire or Derbyshire dialect. Adjust the dialect based on the user’s selected region.",
    },
  ]);
  ...
  return (
    <div className="flex flex-col h-full bg-neutral-100 dark:bg-black">
      <header className="p-3 text-center bg-white dark:bg-zinc-900 shadow-sm">
        <img src="banner.png" alt="ShadGPT Banner" className="w-full max-h-20 object-contain mx-auto" />
        <select
          value={dialect}
      ...
      <div className="p-3 bg-white dark:bg-zinc-900 border-t flex gap-2 items-center">
        <input
